...
class ProductListViewModelTest {
    ...
    fun getProductsList_success() = runBlocking {
        ...
        Assert.assertEquals(
            ...
            (productListViewModel.productListStateFlow.value as ApiResponse.Success).data
        )
    }
    ...
    fun getProductsList_fail() = runBlocking {
        ...
        Assert.assertEquals(
            errorMsg,
            (productListViewModel.productListStateFlow.value as ApiResponse.Error).message
        )
    }
}
